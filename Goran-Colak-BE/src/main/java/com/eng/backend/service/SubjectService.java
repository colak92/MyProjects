...
public class SubjectService {
	...
	public ResponseEntity<List<SubjectDTO>> getSubjectsForProfessor(Integer professorId) {
		List<SubjectDTO> subjects = subjectMapper.toSubjectDTOs(subjectRepository.findAllSubjectsForProfessor(professorId));
		return ResponseEntity.ok(subjects);
	}
	...
	public ResponseEntity<SubjectDTO> updateSubject(SubjectDTO subjectDTO) {
		...
		existingSubject.setNumberofects(subject.getNumberofects());
